  ...
  <!-- Feedback Form -->
        <div class="g-position--relative g-bg-color--primary">
            <div class="g-container--md g-padding-y-125--xs">
                ...
                <form class="center-block g-width-500--sm g-width-550--md" action="/sad" method='post'>
                {{ csrf_field() }}
                    <div class="g-margin-b-30--xs">
                        <input aria-required="true" name='name'type="text" class="form-control s-form-v3__input" placeholder="* Name">
                    </div>
                    <div class="row g-row-col-5 g-margin-b-50--xs">
                        <div class="col-sm-6 g-margin-b-30--xs g-margin-b-0--md">
                            <input aria-required="true" name='email'type="email" class="form-control s-form-v3__input" placeholder="* Email">
                        </div>
                        <div class="col-sm-6">
                            <input aria-required="true" name='phone' type="text" class="form-control s-form-v3__input" placeholder="* Phone">
                        </div>
                    </div>
                    <div class="g-margin-b-80--xs">
                        <textarea aria-required="true" class="form-control s-form-v3__input" rows="5" name='message' placeholder="* Your message"></textarea>
                    </div>
                    <div class="g-text-center--xs">
